...
<body>
	<div class="navbar navbar-static-top">
   		<div class="container">
   			...
   			<a href="ViewProfileInitAction">
				<img style="margin-top: 3%;" align="left" class="img-responsive" src="logo-ibm-white.png" width="20%" height="20%"/>
			</a>
			</div>
			<div>
			  	<a class="btn dropdown-toggle" data-toggle="dropdown" href="#" style="width: 80%">
			    	<img style="margin-top: 3%" align="right" class="img-responsive" src="profile_icon_3.ico" width="13%" height="13%"/>
			 	 </a>
	...
	<div align="right" style="padding-right: 3%;">
		<font style="font-size: x-small;">Hi, Pannray Samanphanchai</font>
	</div>
	<div class="container">
	...
	<div align="center">
		<font style="font-size: x-small;">
			...
			<a class="test" data-placement="bottom" href="#" data-toggle="tooltip" title="Hooray!" >Forgot Password</a><br>
